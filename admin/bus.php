    ...
    <?php
        ...
        */
        ...
        <?php
            ...
            <section id="bus">
                <div id="head">
                    <h4>Cable Car Status</h4>
                </div>
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Cable Cars Detail <i class="fas fa-plus"></i></button>
                    </div>
                    
                    <table class="table table-hover table-bordered">
                        <thead>
                            <th>#</th>
                            <th>Cable Car number</th>
                            <th>Actions</th>
                        </thead>
                        <?php
                            $ser_no = 0;
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Cable Car Number</label><br>
