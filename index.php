...
<head>
    ...
    <title>Manakamana Cablecar Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Cable Car Number : </strong>
                            <?php echo $bus_no; ?>
                        </li>
                        <li>
    ...
    <header>
        <nav>
            ...
            <div>
                ...
                <a href="#pnr-enquiry" class="pnr nav-item">Check Your Ticket Here:</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Manakamana CableCar Ticket Booking System</h1>

            <p class="text-center">Welcome to Manakamana cable car Ticket Booking System. Login now to manage Cable Car tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        <section id="info-num">
            <figure>
                <img src="assets/img/cable-car-svgrepo-com.svg" alt="Bus Route Icon" width="100px" height="100px">
                <figcaption>
            ...
            <figure>
                <img src="assets/img/cable-car.svg" alt="Bus Icon" width="100px" height="100px">
                <figcaption>
                    <span class="num counter" data-target="<?php echo count($busData); ?>">999</span>
                    <span class="icon-name">Cable Cars</span>
                </figcaption>
            </figure>
            <figure>
